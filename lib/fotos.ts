...
export const HUECOS: Hueco[] = [
  // ---------------------------------------------------------------- YA HAY
  {
    ...
    encargo: {
      es: "Vista aérea del predio completo desde el aire, con el pabellón, el paseo y el jardín.",
      en: "Aerial view of the whole site, with the Pavilion, the walk and the garden.",
    },
    alt: {
      es: "Vista aérea del predio: el pabellón techado, el paseo central y el jardín con palmeras",
      en: "Aerial view of the site: the covered pavilion, the central walk and the palm garden",
    },
    prioridad: "alta",
  },
  {
    ...
    alt: {
      es: "El paseo pavimentado del jardín entre dos hileras de palmeras, con el pabellón al fondo",
      en: "The garden's paved walk between two rows of palms, with the Pavilion behind",
    },
    prioridad: "alta",
  },
  {
    ...
    encargo: {
      es: "Bajo el pabellón mirando al techo: la estructura de paja sobre los postes.",
      en: "Under the Pavilion looking up: the thatch on the timber posts.",
    },
    alt: {
      es: "Bajo el pabellón: techo de paja a cuatro aguas sobre postes de madera, abierto por los costados",
      en: "Under the Pavilion: four-hipped thatch roof on timber posts, open on the sides",
    },
    prioridad: "alta",
  },
  ...
  // ------------------------------------------------------------- FALTAN
  {
    ...
    encargo: {
      es: "El pabellón ENTERO desde fuera y de día, a la altura de los ojos. Es la foto que falta para saber qué forma tiene: hoy solo hay una de dentro y una aérea, y por eso el plano la dibuja mal.",
    ...
    alt: {
      es: "El pabellón completo, con su techo de paja, vista desde el jardín, con las palmeras alrededor",
      en: "The complete covered pavilion seen from the garden, with palms around it",
    },
    prioridad: "alta",
  },
  {
  ...
  },
  {
    ...
    encargo: {
      es: "Las seis cabañas amuebladas, o al menos tres o cuatro en fila. Salen en la ficha técnica como dato verificado y no hay ninguna foto suya.",
      en: "The six furnished cabanas, or at least three or four in a row. They appear in the spec sheet as verified data and there is no photograph of them.",
    },
    alt: {
  ...
  },
  {
    ...
    alt: {
      es: "Un evento montado en el recinto, con mesas e invitados bajo el pabellón",
      en: "An event set up on site, with tables and guests under the Pavilion",
    },
    prioridad: "alta",
  },
  {
