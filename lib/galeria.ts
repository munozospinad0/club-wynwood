...
export const GALERIA: FotoGaleria[] = [
  ...
  { id: "bajo-palapa", src: "/assets/venue-palapa.webp", w: 1280, h: 960, fuente: SITIO,
    alt: { es: "Bajo el pabellón: paja sobre madera, abierto por los costados", en: "Under the Pavilion: thatch on timber, open on the sides" } },
  ...
  { id: "coctel", src: "/assets/flyer-palapa-coctel.jpg", w: 548, h: 1434, fuente: FLYER,
    alt: { es: "Bajo el pabellón: mesas de cóctel y guirnaldas entre los cabios", en: "Under the Pavilion: cocktail tables and string lights among the rafters" } },
  { id: "montaje", src: "/assets/palapa-montaje.jpg", w: 1600, h: 1200, fuente: SITIO,
    alt: { es: "Un montaje de sonido e iluminación bajo el pabellón", en: "A sound and lighting setup under the Pavilion" } },
